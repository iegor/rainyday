...
HOMEPAGE="https://github.com/webdesigner97/streets"
SRC_URI=""

EGIT_REPO_URI="https://github.com/webdesigner97/streets.git"
EGIT_BRANCH="master"
...
src_install() {
	...
	insinto ${GAMES_DATADIR}/minetest/games/minetest_game/mods/streets
	doins -r ${S}/*
