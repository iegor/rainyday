...
DESCRIPTION="[GIT] KDE multi-protocol IM client"
HOMEPAGE="http://kopete.kde.org/"
IUSE="emoticons-manager jingle ssl xscreensaver slp kernel_linux kdehiddenvisibility opengl"
PLUGINS="
	addbookmarks
	alias 
	autoreplace
